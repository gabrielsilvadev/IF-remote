from tkinter import *
from Banco import Banco #importando o aquivo banco e suas class
#from Pillow import Image, ImageTk
#import Usuarios 

root = Tk()

banco = Banco()   # recebe a classe banco 
a = [] # cria lista 
...
button_do_usuario=Button(root,background="#CB6121",image=usuario)#butao do usuario qu esta recebendo  a imagem 
button_do_usuario['font']=("Arial","8")# regulando ao fonte 
...
button_do_usuario.place(x = 15, y = 15)# dime3nsionamento do butao 

#texto que fica obre o butao 
text2=Label(root,text="usuario",background="#321B4A",foreground='white')
text2['padx']=20
text2['pady']=3
...
button1['font']=("Arial","8")#tamanha da letra 
...
text3=Label(root,text=a[1],background="#CB6121",foreground='white')
text3['padx']=20
text3['pady']=3
text3['font']=("Arial","7",'bold')
text3.place(x = 17, y = 232)
...
text4=Label(root,text=a[0],background="#CB6121",foreground='white')
text4['padx']=20
text4['pady']=3
text4['font']=("Arial","8",'bold')
text4.place(x = 307, y = 230)
...
text5=Label(root,text=a[8],background="#CB6121",foreground='white')
text5['padx']=10
text5['pady']=3
text5['font']=("Arial","8",'bold')
text5.place(x = 460, y = 230)
...
button4=Button(root,background="#CB6121",image=pi)
button4['font']=("Arial","8")
button4["width"] = 120
button4['fg']='#DFDCE3'
button4["height"] = 100
button4.place(x = 150, y = 150)

#caixa de texto que recebe o nome da sala de estudo atraves do indice 
text6=Label(root,text=a[9],background="#CB6121",foreground='white')
text6['padx']=10
text6['pady']=3
text6['font']=("Arial","5",'bold')
text6.place(x = 152, y = 237)
#importando a imagem 
...
button5=Button(root,background="#CB6121", image=sala_de_leitura)
button5['font']=("Arial","8")
button5["width"] = 120
button5['fg']='#DFDCE3'
button5["height"] = 100
button5.place(x = 570, y = 150)
#caixa de   texto que recebe  o nome atraves do indice 
text7=Label(root,text=a[7],background="#CB6121",foreground='white')
text7['padx']=10 
text7['pady']=3
text7['font']=("Arial","8",'bold')
text7.place(x = 575, y = 231)
#importando a imagem dos laboratorios 
lab = PhotoImage(file = r"computer.png") 
lab = lab.subsample(10,10)
#criando botao que recebe  a foto dos laboratorios 
button6=Button(root,background="#CB6121", image =lab)
button6['font']=("Arial","8")
button6['fg']='#DFDCE3'
button6["width"] = 120
button6["height"] = 100
...
text8=Label(root,text=a[2],background="#CB6121",foreground='white')
text8['padx']=10
text8['pady']=3
text8['font']=("Arial","8",'bold')
text8.place(x =18 , y = 380)

# criando button  que recebe a foto lab
button7=Button(root,background="#CB6121",image = lab)
button7['font']=("Arial","8")
button7["width"] = 120
button7['fg']='#DFDCE3'
button7["height"] = 100
button7.place(x = 11, y = 300)

# criando caixa de texto que acessa o nome do lab atraqvs do indice da lista 
text9=Label(root,text=a[3],background="#CB6121",foreground='white')
text9['padx']=10
text9['pady']=3
text9['font']=("Arial","8",'bold')
text9.place(x = 158, y = 380)

#criando button que vai receber a imagem 
button8=Button(root, background="#CB6121",image=lab)
button8['text']="lab"
button8["width"] = 120
button8["height"] = 100
button8['fg']='#DFDCE3'
button8.place(x = 290, y = 300)
#criando caixa de texto que vai receber o nome atarves do indice 
text10=Label(root,text=a[4],background="#CB6121",foreground='white')
text10['padx']=10
text10['pady']=3
text10['font']=("Arial","8",'bold')
text10.place(x = 298, y = 380)

#criando button que vai receber a imagem 
button9=Button(root, background="#CB6121",image=lab)
button9['font']=("Arial","8")
button9["width"] = 120
button9['fg']='#DFDCE3'
button9["height"] = 100
button9.place(x = 430, y = 300)
#criando caixa de texto que vai receber indice 
text11=Label(root,text=a[5],background="#CB6121",foreground='white')
text11['padx']=10
text11['pady']=3
text11['font']=("Arial","8",'bold')
text11.place(x = 437, y = 380)
        
#criando button que vai receber a imagem 
button10=Button(root,background="#CB6121",image=lab)
button10['font']=("Arial","8")
button10["width"] = 120
button10['fg']='#DFDCE3'
button10["height"] = 100
button10.place(x = 570, y = 300)
#criando t5exto que acessa o nome ataves do indice 
text12=Label(root,text=a[6],background="#CB6121",foreground='white')
text12['padx']=10
text12['pady']=3
text12['font']=("Arial","8",'bold')
text12.place(x = 577, y = 380)


root['background']='#321b4a'#configurando a cor de fundo 
root.geometry('800x600+0+0')#dimensionando na tela 
root.mainloop()# criando laco para manter a tela aberta 
